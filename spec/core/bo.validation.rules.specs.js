...
describe('Validation', function () {
    ...
    describe('with a requiredIf validator', function () {
        it('should true if value does not trigger required validation and value is empty', function () {
            var isValid, value;
            value = void 0;
            isValid = bo.validation.rules.requiredIf.validator(value, {
        ...
        it('should throw an error if a property or value field is not provided', function () {
            ...
            func = function () {
                bo.validation.rules.requiredIf.validator(model.conditionallyRequiredProperty, {
                    equalsOneOf: ['']
                }, model);
            };
    ...
    describe('with a requiredIfNot validator', function () {
        it('should true if value does not trigger required validation and value is empty', function () {
            var isValid, value;
            value = void 0;
            isValid = bo.validation.rules.requiredIfNot.validator(value, {
                value: ko.observable('notTriggering'),
        ...
        it('should throw an error if a property or value field is not provided', function () {
            ...
            func = function () {
                bo.validation.rules.requiredIfNot.validator(model.conditionallyRequiredProperty, {
                    equalsOneOf: ['']
                }, model);
            };
            expect(func).toThrow('You need to provide a value.');
    ...
    describe('with a custom validator', function () {
        it('should throw an error if the options parameter is undefined', function () {
            var func;
            func = function () {
                bo.validation.rules.custom.validator('a value', void 0, {});
            };
