    ...
    return describe(methodName, function () {
        describe('success', function () {
            beforeEach(function () {
                ...
                this.request = bo.ajax.url(this.path)[methodName]();
        ...
        describe('listening for all requests - all successful', function () {
            beforeEach(function () {
                ...
                this.aggregatePromise = bo.ajax.listen(function () {
                ...
                this.requestOutsideOfDetection = bo.ajax.url('/OutsideDetectionPath')[methodName]();
...
describe('ajax', function () {
    ...
    describe('POST specific', function () {
        it('should POST "values"', function () {
            this.request = bo.ajax.url('/AUrl').data({
                id: 342
            }).post();
        });
    });
