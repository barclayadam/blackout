describe 'DataSource', ->
    ...
    describe 'When a data source is created with a default sort order', ->
        ...
        it 'should set the sortBy observable to be a string representation of the ordering', ->
            expect(@dataSource.sortBy()).toEqual 'myProperty ascending'
    ...
    describe 'When a data source is sorted by multiple properties, with complex data set and no paging', ->
        ...
        it 'should set the sortBy observable to the normalised passed in properties', ->
            expect(@dataSource.sortBy()).toEqual 'myProperty ascending, myOtherProperty ascending'
    ...
    describe 'When a data source is sorted after a load, with server paging', ->
        ...
        it 'should pass the sortBy value as a parameter to loader', ->
            expect(@loader).toHaveBeenCalledWith
                pageNumber: 1
                pageSize: 5
