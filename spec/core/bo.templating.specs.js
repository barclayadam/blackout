describe('templating', function () {
    ...
    describe('string templates', function () {
        ...
        describe('when a named template is an observable', function () {
            beforeEach(function () {
                ...
                bo.templating.set('myNamedTemplate', this.template);
                this.setHtmlFixture("<div id=\"templated\" data-bind=\"template: 'myNamedTemplate'\"></div>");
                this.applyBindingsToFixture({});
                this.wrapper = document.getElementById('templated');
            });
    ...
    describe('external templates', function () {
        describe('when a template name does not match an existing element, or string template it is loaded externally', function () {
            ...
            it('should immediately render the loading template (bo.templating.loadingTemplate)', function () {
                expect(this.wrapperOne).toHaveHtml(bo.templating.loadingTemplate);
                expect(this.wrapperTwo).toHaveHtml(bo.templating.loadingTemplate);
            });
            ...
            describe('when template is successfully loaded using bo.templating.externalPath', function () {
                beforeEach(function () {
                    this.server.respond();
                });
