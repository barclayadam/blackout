...
bo.routing.Router = (function () {
    ...
    function Router() {
        ...
        bo.bus.subscribe('urlChanged:external', function (msg) {
            ...
            if (matchedRoute === void 0) {
                ...
                return _this._doNavigate(msg.url, matchedRoute.route, matchedRoute.parameters);
            }
        });
    }
    ...
    Router.prototype._doNavigate = function (url, route, parameters) {
        ...
        this.currentParameters = _.extend(parameters, new bo.Uri(url).variables);
        ...
        return bo.bus.publish("routeNavigated:" + route.name, msg);
    };
    ...
    */
    Router.prototype.route = function (name, url, callbackOrOptions, options) {
        if (options == null) {
            options = {
                title: name
            };
